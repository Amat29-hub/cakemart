    ...
    <div class="col-md-12">
      <div class="card shadow-sm rounded-3">
        <div class="card-body text-center">
            ...
            <table class="table align-middle text-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  {{-- Toggle --}}
                  <td>
                    <form action="{{ route('gallery.toggleStatus',$gallery->id) }}" method="POST" class="d-inline">
                      @csrf @method('PATCH')
                      <label class="toggle-switch">
                        <input type="checkbox" onchange="this.form.submit()" {{ $gallery->is_active ? 'checked':'' }}>
                  ...
                  {{-- Tombol edit & delete --}}
                  <td>
                    <a href="{{ route('gallery.edit',$gallery->id) }}" class="btn btn-warning btn-sm text-white fw-bold">
          ...
          <a href="{{ route('gallery.create') }}" class="btn btn-primary mt-3 fw-bold">+ Add New Photo</a>
        </div>
      </div>
    </div>
  </div>
