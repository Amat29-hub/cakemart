@extends('layout.frontend.martapp')
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="{{ asset('assetsfrontend/images/product-thumb-2.png') }}" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-vegetables-broccoli.png') }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-bread-baguette.png') }}" alt="Category Thumbnail">
                  <h3 class="category-title">Breads & Sweets</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-soft-drinks-bottle.png') }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-wine-glass-bottle.png') }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-animal-products-drumsticks.png') }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-bread-herb-flour.png') }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-vegetables-broccoli.png') }}" alt="Category Thumbnail">
                ...
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-vegetables-broccoli.png') }}images/" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset('assetsfrontend/images/icon-vegetables-broccoli.png') }}" alt="Category Thumbnail">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('assetsfrontend/images/product-thumb-11.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('assetsfrontend/images/product-thumb-12.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{ asset('assetsfrontend/images/product-thumb-13.jpg') }}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Amber Jar</p>
                  ...
                  <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                      ...
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="{{ asset('assetsfrontend/images/thumb-bananas.png') }}"  class="tab-image">
                          </a>
                        </figure>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="{{ asset('assetsfrontend/images/thumb-biscuits.png') }}"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="{{ asset('assetsfrontend/images/thumb-cucumber.png') }}"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="{{ asset('assetsfrontend/images/thumb-milk.png') }}"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                  ...
                  <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="{{ asset('assetsfrontend/images/thumb-orange-juice.png') }}"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="{{ asset('assetsfrontend/images/thumb-raspberries.png') }}"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                  ...
                  <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="{{ asset('assetsfrontend/images/thumb-tomatoes.png') }}"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
                    ...
                    <div class="col">
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.html" title="Product Title">
                            <img src="{{ asset('assetsfrontend/images/thumb-tomatoketchup.png') }}"  class="tab-image">
                          </a>
                        </figure>
                        <h3>Sunstar Fresh Melon Juice</h3>
                        <span class="qty">1 Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
      ...
      <div class="container-fluid">
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <img src="{{ asset('assetsfrontend/images/phone.png') }}" alt="phone" class="image-float img-fluid">
              </div>
              <div class="col-md-8">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  <img src="{{ asset('assetsfrontend/images/app-store.jpg') }}" alt="app-store">
                  <img src="{{ asset('assetsfrontend/images/google-play.jpg') }}" alt="google-play">
                </div>
              </div>
            </div>
          </div>
